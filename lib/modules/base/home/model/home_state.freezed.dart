...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool showBanner, List<HomeItem> items});
}
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl(
      {required this.showBanner, required final List<HomeItem> items})
      : _items = items;
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      ...
      required final List<HomeItem> items}) = _$HomeStateImpl;
